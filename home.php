...
<head>
      ...
      <title>หน้าแรก - Ornamental Plant Diseases</title>
      ...
      <main id="main">
            ...
            <!-- <div class="homeheader">
                  <div class="align">
                        ...
                        <div>
                              <h4 class="titlehome2">เว็บแอปพลิเคชันเพื่อการวินิจฉัยโรคในไม้ประดับ</h4>
                        </div>
                  </div>
            </div> -->
            <div class="homeheader">
                  <div class="px-4 py-5 my-5">
                        <h4 class="display-5 fw-bold titlehome">Web application for diagnosis of ornamental plant diseases</h4>
                        <h4 class="display-5 fw-bold titlehome2">เว็บแอปพลิเคชันเพื่อการวินิจฉัยโรคในไม้ประดับ</h4>
                  </div>
            </div>
            ...
            <section id="services" class="services">
                  <div class="container" data-aos="fade-up">
                        <div class="section-title">
                              ...
                              <h5>คำแนะนำ : หากผู้ใช้งานไม่ทราบชื่อโรคของไม้ประดับ สามารถเลือกเมนูวินิจฉัยโรคเพื่อทำการวินิจฉัยโรคในไม้ประดับได้เลย</h5>
                        </div>
